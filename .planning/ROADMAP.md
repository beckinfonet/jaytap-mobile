...
| 5. Hardening + Manual Physical-Device QA + Release v3.0.0 | 5/7 | Executing (Plans 05-01 pre-flight + 05-02 store-history + 05-03 atomic v3.0.0 bump + 05-04 release notes + 05-05 QA matrix APPROVED-WITH-MASS-DISPOSITION via Path B closed 2026-05-11 at HEAD `4240e64`; 05-06 paired-gate + 05-07 dual-store submission remaining) | — |
