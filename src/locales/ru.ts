...
export const ru: Record<TranslationKeys, string> = {
  ...
  'property.unarchiveDialogMessage': 'Вернуть это объявление в Черновики? Вам нужно будет повторно опубликовать его на экране редактирования, чтобы оно снова появилось в поиске.',
  ...
  'property.unarchivedToastTitle': 'Объявление в черновиках',
  'property.unarchivedToastMessage': 'Откройте объявление и нажмите "Редактировать", чтобы опубликовать его, когда будете готовы.',
