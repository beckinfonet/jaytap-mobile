...
export const ru: Record<TranslationKeys, string> = {
  ...
  // Действия администратора над опубликованным объявлением (kebab-меню, подтверждение
  // приостановки/восстановления, удаление с вводом DELETE, экран управления, редактирование
  // медиа и ошибки). Плоские ключи в соответствии с конвенцией кодовой базы.
  'adminListing.menu.a11y': 'Действия администратора',
  'adminListing.menu.editMedia': 'Изменить медиа…',
  'adminListing.menu.suspend': 'Приостановить объявление',
  'adminListing.menu.restore': 'Восстановить объявление',
  'adminListing.menu.delete': 'Удалить объявление',
  'adminListing.menu.manage': 'Управление объявлением…',
  'adminListing.restore.title': 'Восстановить объявление?',
  'adminListing.restore.body': 'Объявление вернётся в очередь на повторное рассмотрение.',
  'adminListing.restore.confirm': 'Восстановить',
  // restore.cancel переиспользует common.cancel (конвенция проекта).
  'adminListing.restore.success': 'Объявление восстановлено',
  'adminListing.delete.title': 'Удалить объявление навсегда?',
  'adminListing.delete.body': 'Это действие необратимо. Объявление и все его медиафайлы будут удалены из базы данных. Введите DELETE для подтверждения.',
  'adminListing.delete.inputPlaceholder': 'Введите DELETE',
  'adminListing.delete.confirm': 'Удалить навсегда',
  // delete.cancel переиспользует common.cancel (конвенция проекта).
  'adminListing.delete.blockedReason': 'Сначала приостановите объявление.',
  'adminListing.delete.success': 'Объявление удалено',
  'adminListing.manage.title': 'Управление объявлением',
  'adminListing.manage.status.label': 'Статус',
  'adminListing.manage.status.live': 'Опубликовано',
  'adminListing.manage.status.pending': 'На рассмотрении',
  'adminListing.manage.status.rejected': 'Отклонено',
  'adminListing.manage.status.archived': 'Приостановлено',
  ...
  'adminListing.manage.archivedNote': 'Примечание',
  'adminListing.manage.copy.a11y': 'Скопировать в буфер',
  'adminListing.manage.copy.done': 'Скопировано',
  'adminListing.mediaEdit.headerTitle': 'Изменить медиа',
  'adminListing.mediaEdit.saveButton': 'Сохранить изменения',
  'adminListing.mediaEdit.saveSuccess': 'Медиафайлы сохранены',
  'adminListing.errors.permissionDenied': 'У вас больше нет прав на это действие.',
  'adminListing.errors.listingGone': 'Этого объявления больше не существует.',
  'adminListing.errors.suspendFailed': 'Не удалось приостановить объявление.',
  'adminListing.errors.restoreFailed': 'Не удалось восстановить объявление.',
  'adminListing.errors.deleteFailed': 'Не удалось удалить объявление.',
